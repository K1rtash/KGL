...
void Mesh::Draw(Shader* shader, Camera* camera, glm::mat4 matrix, glm::vec3 translation, glm::quat rotation, glm::vec3 scale)
{
	...
	glUniformMatrix4fv(glGetUniformLocation(shader->id, "translation"), 1, GL_FALSE, glm::value_ptr(t));
	glUniformMatrix4fv(glGetUniformLocation(shader->id, "rotation"), 1, GL_FALSE, glm::value_ptr(r));
	glUniformMatrix4fv(glGetUniformLocation(shader->id, "scale"), 1, GL_FALSE, glm::value_ptr(s));
